...
### View #2
![](img/view2.png)
- **Task abstraction:** This multi-line chart allows users to explore and compare the changes in sentiment analysis scores for NYT article about each U.S. democratic candidate over the course of the primary process.
- **Data Abstraction:** 
    ...
    * The attributes visualized for the multi-line chart include:
        ...
        * `Date` (ordinal; 305 levels/days (July 1st, 2019 to May 1st, 2020))
...
| Month selection widget        |       6.5 | 6.5          | MP          |
| **View #3**                       |           |             |             |
